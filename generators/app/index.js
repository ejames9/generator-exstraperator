...
-* generator-exstraperator *-

This is the main logic file for the generator-exstraperator, Express and Bootstrap
...
module.exports = Yeoman.extend({
  constructor: function () {
    ...
    // Greet the user.
    this.log(yosay(
      chalk.red('Welcome to the Magnificent ') + chalk.white('Express') + chalk.red(', ') + chalk.magenta('Bootstrap') + ' ' + chalk.red('generator ') + chalk.white('ex') + chalk.magenta('strap') + chalk.red('erator') + chalk.red('!')
    ));
  },
